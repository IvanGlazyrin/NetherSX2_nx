...
std::string display_name(std::string_view name_view) {
  std::string name(trim_copy(name_view));
...
int add_group(ParsedFile *parsed, std::string_view name, unsigned unnamed_index) {
  Group group;
  if (name.empty())
